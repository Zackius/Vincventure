  ...
  return (
    <section className='py-32 content-center'>
      <section>
        ...
        <h2 className='text-2xl font-bold md:text-4xl text-red-600 capitalize text-center underline'>Solar street Lamp</h2>
          ...
          <div className='text-center'>
          <h2 className='text-xl md:text-2xl font-bold text-red-600 capitalize p-3 underline '>Lamp Specification</h2>
        ...
        <div className='py-6'>
          <h2 className='text-2xl font-bold md:text-4xl text-red-600 capitalize text-center underline'>Bright LEDS</h2>
          <div className='hero container max-w-screen-lg mx-auto pb-10'>
        ...
        <div className='py-6'>
          <h2 className='text-2xl font-bold md:text-4xl text-red-600 capitalize text-center underline'>SOLAR PANEL</h2>
          <div className='hero container max-w-screen-lg mx-auto pb-10'>
      ...
      <input className='appearance-none block  w-[300px]  md:w-[500px] bg-gray-200 text-gray-500 border  rounded-2xl  py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white' type="text" name="user_name" placeholder='John Doe' required />
        </div>
        <div>
        <label className='text-xl font-bold'>Phone Number <span className='text-red-600'>*</span></label>
      <input className='appearance-none block w-[300px] md:w-[500px] bg-gray-200 text-gray-500 border  rounded-2xl  py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white' type="integer" name="phone_number" placeholder=" +254"required />
     </div>
        <div>
        <label className='text-xl font-bold'>Delivery Location  <span className='text-red-600'>*</span> </label>
      <textarea className='appearance-none block w-[300px] md:w-[500px] bg-gray-200 text-gray-500 border  rounded-2xl  py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white '  name="delivery_location" placeholder='Nairobi, Kahawa west'  required/>
          </div>
          <div>
      ...
      <textarea className='appearance-none block w-[300px] md:w-[500px] bg-gray-200 text-gray-500 border  rounded-2xl  py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white ' type="text"  name="optional_note" />
          </div>
        <div>
